        ...
        for i in range(num_expressions):
            ...
            if args.visualize:
                for t, frame in enumerate(frames):
                    ...
                    draw_reference_points(draw, ref_points, source_img.size,
...
if __name__ == '__main__':
    ...
    # args.__setattr__('pretrained_weights', '/public/home/lfzh/LYF/ReferFormer/coco/pretrain/r50_pretrain.pth')
    # args.__setattr__('output_dir', './output/ytvos/20240627/')
    # args.__setattr__('device', 'cpu')
    # args.__setattr__('ytvos_path', '/public/home/lfzh/LYF/ReferFormer/data/ref-youtube-vos')
    # args.__setattr__('resume', '/Users/zyaire/Downloads/checkpoint.pth')
